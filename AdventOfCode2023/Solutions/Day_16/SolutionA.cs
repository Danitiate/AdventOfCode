...
namespace AdventOfCode2023.Solutions.Day_16
{
    /**
     *  PART 1
     *  1. Parse input into a grid of cells
     *  2. Starting from the north-west corner (0,0), traverse eastwards and mark each cell along the way
     ...
     *  3. After all cells are traversed and marked, count the amount of energized cells and return the results
     **/
    public class SolutionA : Solution
    {
        ...
        private int CountEnergizedTiles()
        {
            ...
            TraverseGrid(grid, grid[0,0], Direction.EAST);
